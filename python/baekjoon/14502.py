...
Implementation, Graph Theory, Bruteforcing, Graph Traversal, Breadth-first Search
"""
...
# 최선의 경우를 규칙성을 활용해서 찾기 어렵다면, 복잡도를 고려하여 완전 탐색 수행
# 2차원 배열을 깊은 복사하기 위해 copy.deepcopy() 사용
# python3는 시간초과, PyPy3는 통과 => 조합을 사용하여 속도 개선 가능 (combinations)